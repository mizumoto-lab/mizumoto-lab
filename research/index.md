...
- How do leaders and followers maintain coordinated motion?
- How are mating and search behavior organized in time and space?
- How and why have coordination rules diversified across species?

[Learn more about tandem running](topics-tandem).
...
A major current effort is an [NSF-funded project](https://www.nsf.gov/awardsearch/show-award?AWD_ID=2611846) comparing collective excavation and nest construction across termite lineages.

**Major questions**

- How and why do individual building behaviors vary among termite species?
- How do individual-level behaviors generate group-level construction patterns?
- How did collective building originate and diversify during termite evolution?

[Learn more about termite construction](topics-nest).
...
- How do nesting and foraging ecology shape social organization?
- Under what conditions do specialized workers evolve?
- How do life history, behavior, and colony structure evolve together?

[Learn more about comparative termite evolution](topics-phylogeny).
...
{% capture content %}
  {% include figure.html image="images/pub/Hu-Mizumoto-2026-1.png" alt="Map showing records of Formosan subterranean termites across Alabama" caption="Distribution of Formosan subterranean termites in Alabama. [Link](https://link.springer.com/article/10.1007/s11252-026-02107-z)" width="400px" %}
{% endcapture %}
{%
  include float.html
  content=content
...
- Field natural history and specimen collection
- Behavioral experiments, video recording, and computational tracking
- Natural-history databases and biodiversity mapping
- Phylogenetic comparative analysis, mathematical modeling, and simulation

See [Join the Lab]({{ "/join/" | relative_url }}) for current opportunities.
